  ...
  const projects = [
    {
      id: 1,
      title: "GAM",
      description: "GAM is a consortium of physicians creating novel metrics of healthcare quality. The platform enables real-time tracking of patient outcomes and treatment effectiveness. It integrates advanced analytics to help healthcare providers make data-driven decisions.",
    ...
    },
    {
      id: 2,
      title: "NOVA Finance",
      description: "NOVA offers a new standard in personal finance management with real-time analytics. The platform provides comprehensive financial insights and automated investment strategies. Users can track their spending patterns and receive personalized financial recommendations.",
    ...
    },
    {
      id: 3,
      title: "EcoTrack",
      description: "EcoTrack is an innovative environmental monitoring system that helps businesses track their carbon footprint. The platform provides detailed analytics on energy consumption and waste management. It offers actionable insights for reducing environmental impact.",
      image: "https://images.unsplash.com/photo-1497435334941-8c899ee9e8e9?w=500&auto=format&fit=crop&q=60",
      liveSite: "ECOTRACK.GREEN",
      industry: "Sustainability",
      published: "©2024",
      deliverables: ["WEB APP", "MOBILE APP", "DATA VISUALIZATION", "API INTEGRATION"],
    },
    {
      id: 4,
      title: "ArtFlow",
      description: "ArtFlow is a digital marketplace connecting artists with collectors worldwide. The platform features advanced search algorithms and secure payment processing. It includes a virtual gallery system for immersive art viewing experiences.",
      ...
      published: "©2024",
      deliverables: ["E-COMMERCE", "3D VIEWING", "PAYMENT SYSTEM", "ARTIST PORTFOLIO"],
    },
    {
      id: 5,
      title: "TechLearn",
      description: "TechLearn is an interactive learning platform for technology education. The system offers personalized learning paths and real-time progress tracking. It includes hands-on coding exercises and virtual lab environments.",
      image: "https://images.unsplash.com/photo-1501504905252-473c47e087f8?w=500&auto=format&fit=crop&q=60",
      liveSite: "TECHLEARN.EDU",
      industry: "Education",
      published: "©2024",
      deliverables: ["LEARNING MANAGEMENT", "VIRTUAL LABS", "PROGRESS TRACKING", "CERTIFICATION SYSTEM"],
    }
  ];
  ...
  return (
    <>
      <div className="h-[30vh] w-full flex flex-col md:flex-row items-center md:items-end justify-between bg-[#FF4E27] p-[4vw] md:p-[1vw] gap-4 md:gap-0">
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white">projects</h1>
